        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if args.model_type in ["xlnet", "xlm"]:
                ...
                if args.version_2_with_negative:
                    inputs.update({"is_impossible": batch[8]})
...
def main():
    ...
    parser.add_argument(
        "--output_dir",
        default="/media/jionie/my_disk/Kaggle/Tweet/model/TweetRoberta",
        type=str,
    ...
    parser.add_argument(
        "--train_file",
        default="train_fold_0_seed_1996.json",
        type=str,
    ...
    parser.add_argument(
        "--predict_file",
        default="val_fold_0_seed_1996.json",
        type=str,
